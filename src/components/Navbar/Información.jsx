...
export default function Información() {
  ...
  return (
    <div>
      ...
      {/* <nav
          className="fixed top-0 left-0 right-0 z-50 bg-[#372418] w-full shadow-lg"
          aria-label="Global"
        > */}
        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <img className="h-8 w-auto" src="img/logo_navbar.png" alt="" />
            </a>
          </div>
        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-10 h-fit rounded-b-3xl w-full overflow-y-auto  bg-[#372418]  px-6 py-6 sm:max-w-full sm:ring-1 sm:ring-gray-900/10">
